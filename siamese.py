...
dataset = SiameseDataset('./dataset/Train/drebin_train_per.csv')
...
for epoch in range(20):
    for batch_idx, (anchor, positive, negative) in enumerate(dataset_loader):
        optimizer.zero_grad()
...
torch.save(model.state_dict(), './model/model_right/CNN/Siamese_opcode.pth')
